...
const validationSchema = yup.object({
  payrollNumber: yup.string().required("Please enter your email address."),
...
const EmployeeLogin = () => {
  ...
  useEffect(() => {
    if (user) {
      navigate(`/services/${user.service.slug}`);
    }
  }, [user, navigate]);
          ...
          <Card>
            ...
            <Card.Body>
              <Formik
                ...
                initialValues={{ payrollNumber: "", password: "" }}
                onSubmit={(values) => {
                  dispatch(employeeLogin(values));
                }}
              >
                {(props) => {
                  return (
                    <Form>
                      <Form.Group className="mb-3">
                        ...
                        />
                        {props.touched && <p>{props.errors.payrollNumber}</p>}
                      </Form.Group>
                      <Form.Group className="mb-3">
